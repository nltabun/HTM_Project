...
INSERT INTO `minigame` (question,answer1,answer2,answer3,answer4,correct_answer,difficulty) VALUES
  ...
  ('In 2004 Musk became the chairman of a company which manufactures electric cars. It is named after which historical inventor?','Alexander Graham Bell','Thomas Edison','Nikola Tesla','Guglielmo Marconi','Nicola Tesla', 0),
