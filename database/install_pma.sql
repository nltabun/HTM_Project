...
INSERT INTO `airport` VALUES
  (3622,'KJFK','large_airport','John F Kennedy International Airport',40.639801,-73.7789,13,'NA','US','US-NY','New York','yes','KJFK','JFK','JFK','Manhattan, New York City, NYC, Idlewild,',1),
  (3384,'KATL','large_airport','Hartsfield Jackson Atlanta International Airport',33.6367,-84.428101,1026,'NA','US','US-GA','Atlanta','yes','KATL','ATL','ATL','', 1),
  (3751,'KOMA','medium_airport','Eppley Airfield',41.3032,-95.894096,984,'NA','US','US-NE','Omaha','yes','KOMA','OMA','OMA','', 2),
  (3632,'KLAX','large_airport','Los Angeles International Airport',33.942501,-118.407997,125,'NA','US','US-CA','Los Angeles','yes','KLAX','LAX','LAX','', 3),
  (3631,'KLAS','large_airport','McCarran International Airport',36.08010101,-115.1520004,2181,'NA','US','US-NV','Las Vegas','yes','KLAS','LAS','LAS','', 3),
  (3754,'KORD','large_airport','Chicago O`Hare International Airport',41.9786,-87.9048,672,'NA','US','US-IL','Chicago','yes','KORD','ORD','ORD','CHI, Orchard Place', 2),
  (3791,'KPSM','medium_airport','Portsmouth International at Pease Airport',43.0778999329,-70.8233032227,100,'NA','US','US-NH','Portsmouth','yes','KPSM','PSM','PSM','', 1),
  (3521,'KEWR','large_airport','Newark Liberty International Airport',40.692501,-74.168701,18,'NA','US','US-NJ','New York','yes','KEWR','EWR','EWR','Manhattan, New York City, NYC', 1),
  (16091,'KABQ','medium_airport','Albuquerque International Sunport',35.040199,-106.609001,5355,'NA','US','US-NM','Albuquerque','yes','KABQ','ABQ','ABQ','', 2),
  (3457,'KCLT','large_airport','Charlotte Douglas International Airport',35.2140007019043,-80.94309997558594,748,'NA','US','US-NC','Charlotte','yes','KCLT','CLT','CLT','', 1),
  (3702,'KMOT','medium_airport','Minot International Airport',48.2593994140625,-101.27999877929688,1716,'NA','US','US-ND','Minot','yes','KMOT','MOT','MOT','', 2),
  (3458,'KCMH','large_airport','John Glenn Columbus International Airport',39.998001,-82.891899,815,'NA','US','US-OH','Columbus','yes','KCMH','CMH','CMH','', 1),
  (3747,'KOKC','medium_airport','Will Rogers World Airport',35.393101,-97.6007,1295,'NA','US','US-OK','Oklahoma City','yes','KOKC','OKC','OKC','', 2),
  (3768,'KPDX','large_airport','Portland International Airport',45.58869934,-122.5979996,31,'NA','US','US-OR','Portland','yes','KPDX','PDX','PDX','', 3),
  (3771,'KPHL','large_airport','Philadelphia International Airport',39.87189865112305,-75.24109649658203,36,'NA','US','US-PA','Philadelphia','yes','KPHL','PHL','PHL','', 1),
  (3795,'KPVD','large_airport','Theodore Francis Green State Airport',41.725038,-71.425668,55,'NA','US','US-RI','Providence','yes','KPVD','PVD','PVD','', 1),
  (3450,'KCHS','medium_airport','Charleston International Airport',32.898602,-80.040497,46,'NA','US','US-SC','Charleston','yes','KCHS','CHS','CHS','Charleston Air Force Base', 1),
  (3541,'KFSD','medium_airport','Sioux Falls Regional Airport / Joe Foss Field',43.585463,-96.741152,1429,'NA','US','US-SD','Sioux Falls','yes','KFSD','FSD','FSD','Joe Foss Field, Fighting Lobos, Sioux Fa', 2),
  (3420,'KBNA','large_airport','Nashville International Airport',36.1245002746582,-86.6781997680664,599,'NA','US','US-TN','Nashville','yes','KBNA','BNA','BNA','', 2),
  (3488,'KDFW','large_airport','Dallas Fort Worth International Airport',32.896801,-97.038002,607,'NA','US','US-TX','Dallas-Fort Worth','yes','KDFW','DFW','DFW','QDF', 2),
  (3887,'KSLC','large_airport','Salt Lake City International Airport',40.785749,-111.979746,4227,'NA','US','US-UT','Salt Lake City','yes','KSLC','SLC','SLC','', 3),
  (3430,'KBTV','medium_airport','Burlington International Airport',44.471900939899996,-73.15329742429999,335,'NA','US','US-VT','Burlington','yes','KBTV','BTV','BTV','', 1),
  (3602,'KIAD','large_airport','Washington Dulles International Airport',38.9445,-77.455803,312,'NA','US','US-DC','Washington','yes','KIAD','IAD','IAD','WAS', 1),
  (3604,'KIAH','large_airport','George Bush Intercontinental Houston Airport',29.984399795532227,-95.34140014648438,97,'NA','US','US-TX','Houston','yes','KIAH','IAH','IAH','QHO', 2),
  (3875,'KSEA','large_airport','Seattle Tacoma International Airport',47.449001,-122.308998,433,'NA','US','US-WA','Seattle','yes','KSEA','SEA','SEA','', 3),
  (3467,'KCRW','medium_airport','Yeager Airport',38.3731,-81.593201,981,'NA','US','US-WV','Charleston','yes','KCRW','CRW','CRW','', 1),
  (3690,'KMKE','large_airport','General Mitchell International Airport',42.947200775146484,-87.89659881591797,723,'NA','US','US-WI','Milwaukee','yes','KMKE','MKE','MKE','', 2),
  (3465,'KCPR','medium_airport','Casper-Natrona County International Airport',42.908001,-106.463997,5350,'NA','US','US-WY','Casper','yes','KCPR','CPR','CPR','', 2),
  (3406,'KBHM','medium_airport','Birmingham-Shuttlesworth International Airport',33.562901,-86.753502,650,'NA','US','US-AL','Birmingham','yes','KBHM','BHM','BHM','', 2),
  (5388,'PANC','large_airport','Ted Stevens Anchorage International Airport',61.1744,-149.996002,152,'NA','US','US-AK','Anchorage','yes','PANC','ANC','ANC','', 3),
  (3772,'KPHX','large_airport','Phoenix Sky Harbor International Airport',33.435302,-112.005905,1135,'NA','US','US-AZ','Phoenix','yes','KPHX','PHX','PHX','', 3),
  (3645,'KLIT','medium_airport','Bill & Hillary Clinton National Airport/Adams Field',34.729582,-92.223728,262,'NA','US','US-AR','Little Rock','yes','KLIT','LIT','LIT','', 2),
  (3486,'KDEN','large_airport','Denver International Airport',39.861698150635,-104.672996521,5431,'NA','US','US-CO','Denver','yes','KDEN','DEN','DEN','DVX, KVDX', 2),
  (3396,'KBDL','medium_airport','Bradley International Airport',41.93851,-72.688066,173,'NA','US','US-CT','Hartford','yes','KBDL','BDL','BDL','HFD, Hartford', 1),
  (3608,'KILG','medium_airport','New Castle Airport',39.67869949,-75.60649872,80,'NA','US','US-DE','Wilmington','yes','KILG','ILG','ILG','', 1),
  (3670,'KMCO','large_airport','Orlando International Airport',28.429399490356445,-81.30899810791016,96,'NA','US','US-FL','Orlando','yes','KMCO','MCO','MCO','Disney World,Epcot Center', 1),
  (5453,'PHNL','large_airport','Daniel K Inouye International Airport',21.32062,-157.924228,13,'NA','US','US-HI','Honolulu','yes','PHNL','HNL','HNL','Hickam Air Force Base, HIK, PHIK, KHNL, ', 3),
  (3421,'KBOI','medium_airport','Boise Air Terminal/Gowen Field',43.5644,-116.223,2871,'NA','US','US-ID','Boise','yes','KBOI','BOI','BOI','Boise Air Terminal, Gowen Field', 3),
  (3422,'KBOS','large_airport','Logan International Airport',42.3643,-71.005203,20,'NA','US','US-MA','Boston','yes','KBOS','BOS','BOS','General Edward Lawrence Logan Internatio', 1),
  (3610,'KIND','large_airport','Indianapolis International Airport',39.7173,-86.294403,797,'NA','US','US-IN','Indianapolis','yes','KIND','IND','IND','', 2),
  (3496,'KDSM','medium_airport','Des Moines International Airport',41.534,-93.663101,958,'NA','US','US-IA','Des Moines','yes','KDSM','DSM','DSM','', 2),
  (3605,'KICT','medium_airport','Wichita Eisenhower National Airport',37.649899,-97.433098,1333,'NA','US','US-KS','Wichita','yes','KICT','ICT','ICT','', 2),
  (3873,'KSDF','large_airport','Louisville Muhammad Ali International Airport',38.1744,-85.736,501,'NA','US','US-KY','Louisville','yes','KSDF','SDF','SDF','Louisville International, Standiford Fie', 2),
  (3711,'KMSY','large_airport','Louis Armstrong New Orleans International Airport',29.99340057373047,-90.25800323486328,4,'NA','US','US-LA','New Orleans','yes','KMSY','MSY','MSY','', 2),
  (3796,'KPWM','large_airport','Portland International Jetport',43.646198,-70.309303,76,'NA','US','US-ME','Portland','yes','KPWM','PWM','PWM','', 1),
  (3435,'KBWI','large_airport','Baltimore/Washington International Thurgood Marshall Airport',39.1754,-76.668297,146,'NA','US','US-MD','Baltimore','yes','KBWI','BWI','BWI','WAS', 1),
  (3497,'KDTW','large_airport','Detroit Metropolitan Wayne County Airport',42.212398529052734,-83.35340118408203,645,'NA','US','US-MI','Detroit','yes','KDTW','DTW','DTW','DTT, Detroit Metro Airport', 1),
  (3709,'KMSP','large_airport','Minneapolis–Saint Paul International Airport',44.882,-93.221802,841,'NA','US','US-MN','Minneapolis','yes','KMSP','MSP','MSP','', 2),
  (3619,'KJAN','medium_airport','Jackson-Medgar Wiley Evers International Airport',32.311199,-90.075897,346,'NA','US','US-MS','Jackson','yes','KJAN','JAN','JAN','', 2),
  (3905,'KSTL','large_airport','St Louis Lambert International Airport',38.748697,-90.370003,618,'NA','US','US-MO','St Louis','yes','KSTL','STL','STL','Lambert St Louis', 2),
  (3437,'KBZN','medium_airport','Gallatin Field',45.77750015,-111.1529999,4473,'NA','US','US-MT','Bozeman','yes','KBZN','BZN','BZN','', 3),
  (4731,'MMMX','large_airport','Licenciado Benito Juarez International Airport',19.4363,-99.072098,7316,'NA','MX','MX-DIF','Mexico City','yes','MMMX','MEX','ME1','AICM', 4),
  (4762,'MMUN','large_airport','Cancún International Airport',21.036500930800003,-86.8770980835,22,'NA','MX','MX-ROO','Cancún','yes','MMUN','CUN','','', 4),
  (4710,'MMGL','large_airport','Don Miguel Hidalgo Y Costilla International Airport',20.521799087524414,-103.31099700927734,5016,'NA','MX','MX-JAL','Guadalajara','yes','MMGL','GDL','','', 4),
  (1986,'CYYT','large_airport','St. John`s International Airport',47.618598938,-52.7518997192,461,'NA','CA','CA-NL',"St. John\'s",'yes','CYYT','YYT','','', 4),
  (1990,'CYYZ','large_airport','Lester B. Pearson International Airport',43.6772003174,-79.63059997559999,569,'NA','CA','CA-ON','Toronto','yes','CYYZ','YYZ','YYZ','YTO, Toronto International Airport, Malt', 4),
  (1941,'CYVR','large_airport','Vancouver International Airport',49.193901062,-123.183998108,14,'NA','CA','CA-BC','Vancouver','yes','CYVR','YVR','','', 4),
  (1946,'CYWG','large_airport','Winnipeg / James Armstrong Richardson International Airport',49.909999847399995,-97.2398986816,783,'NA','CA','CA-MB','Winnipeg','yes','CYWG','YWG','YWG','CFB Winnipeg', 4),
  (4664,'MHSC','medium_airport','Palmerola International Airport',14.3824,-87.621201,2061,'NA','HN','HN-CM','Tegucigalpa','yes','MHPR','XPL','','Comayagua International, MHSC, Enrique S', 4)
;
