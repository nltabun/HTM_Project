...
INSERT INTO `airport` VALUES
  ...
  (3384,'KATL','large_airport','Hartsfield Jackson Atlanta International Airport',33.6367,-84.428101,1026,'NA','US','US-GA','Atlanta','yes','KATL','ATL','ATL','',2),
  (3751,'KOMA','medium_airport','Eppley Airfield',41.3032,-95.894096,984,'NA','US','US-NE','Omaha','yes','KOMA','OMA','OMA','',3),
  (3632,'KLAX','large_airport','Los Angeles International Airport',33.942501,-118.407997,125,'NA','US','US-CA','Los Angeles','yes','KLAX','LAX','LAX','',4),
  (3631,'KLAS','large_airport','McCarran International Airport',36.08010101,-115.1520004,2181,'NA','US','US-NV','Las Vegas','yes','KLAS','LAS','LAS','',4),
  (3754,'KORD','large_airport','Chicago O`Hare International Airport',41.9786,-87.9048,672,'NA','US','US-IL','Chicago','yes','KORD','ORD','ORD','CHI, Orchard Place',3),
  ...
  (16091,'KABQ','medium_airport','Albuquerque International Sunport',35.040199,-106.609001,5355,'NA','US','US-NM','Albuquerque','yes','KABQ','ABQ','ABQ','',4),
  (3457,'KCLT','large_airport','Charlotte Douglas International Airport',35.2140007019043,-80.94309997558594,748,'NA','US','US-NC','Charlotte','yes','KCLT','CLT','CLT','',2),
  (3702,'KMOT','medium_airport','Minot International Airport',48.2593994140625,-101.27999877929688,1716,'NA','US','US-ND','Minot','yes','KMOT','MOT','MOT','',3),
  (3458,'KCMH','large_airport','John Glenn Columbus International Airport',39.998001,-82.891899,815,'NA','US','US-OH','Columbus','yes','KCMH','CMH','CMH','',3),
  (3747,'KOKC','medium_airport','Will Rogers World Airport',35.393101,-97.6007,1295,'NA','US','US-OK','Oklahoma City','yes','KOKC','OKC','OKC','',2),
  (3768,'KPDX','large_airport','Portland International Airport',45.58869934,-122.5979996,31,'NA','US','US-OR','Portland','yes','KPDX','PDX','PDX','',4),
  ...
  (3450,'KCHS','medium_airport','Charleston International Airport',32.898602,-80.040497,46,'NA','US','US-SC','Charleston','yes','KCHS','CHS','CHS','Charleston Air Force Base',2),
  (3541,'KFSD','medium_airport','Sioux Falls Regional Airport / Joe Foss Field',43.585463,-96.741152,1429,'NA','US','US-SD','Sioux Falls','yes','KFSD','FSD','FSD','Joe Foss Field, Fighting Lobos, Sioux Fa',3),
  ...
  (3887,'KSLC','large_airport','Salt Lake City International Airport',40.785749,-111.979746,4227,'NA','US','US-UT','Salt Lake City','yes','KSLC','SLC','SLC','',4),
  ...
  (3875,'KSEA','large_airport','Seattle Tacoma International Airport',47.449001,-122.308998,433,'NA','US','US-WA','Seattle','yes','KSEA','SEA','SEA','',4),
  (3467,'KCRW','medium_airport','Yeager Airport',38.3731,-81.593201,981,'NA','US','US-WV','Charleston','yes','KCRW','CRW','CRW','',2),
  (3690,'KMKE','large_airport','General Mitchell International Airport',42.947200775146484,-87.89659881591797,723,'NA','US','US-WI','Milwaukee','yes','KMKE','MKE','MKE','',3),
  (3465,'KCPR','medium_airport','Casper-Natrona County International Airport',42.908001,-106.463997,5350,'NA','US','US-WY','Casper','yes','KCPR','CPR','CPR','',4),
  ...
  (5388,'PANC','large_airport','Ted Stevens Anchorage International Airport',61.1744,-149.996002,152,'NA','US','US-AK','Anchorage','yes','PANC','ANC','ANC','',4),
  (3772,'KPHX','large_airport','Phoenix Sky Harbor International Airport',33.435302,-112.005905,1135,'NA','US','US-AZ','Phoenix','yes','KPHX','PHX','PHX','',4),
  ...
  (3486,'KDEN','large_airport','Denver International Airport',39.861698150635,-104.672996521,5431,'NA','US','US-CO','Denver','yes','KDEN','DEN','DEN','DVX, KVDX',4),
  ...
  (3608,'KILG','medium_airport','New Castle Airport',39.67869949,-75.60649872,80,'NA','US','US-DE','Wilmington','yes','KILG','ILG','ILG','',2),
  (3670,'KMCO','large_airport','Orlando International Airport',28.429399490356445,-81.30899810791016,96,'NA','US','US-FL','Orlando','yes','KMCO','MCO','MCO','Disney World,Epcot Center',2),
  (5453,'PHNL','large_airport','Daniel K Inouye International Airport',21.32062,-157.924228,13,'NA','US','US-HI','Honolulu','yes','PHNL','HNL','HNL','Hickam Air Force Base, HIK, PHIK, KHNL, ',4),
  (3421,'KBOI','medium_airport','Boise Air Terminal/Gowen Field',43.5644,-116.223,2871,'NA','US','US-ID','Boise','yes','KBOI','BOI','BOI','Boise Air Terminal, Gowen Field',4),
  ...
  (3610,'KIND','large_airport','Indianapolis International Airport',39.7173,-86.294403,797,'NA','US','US-IN','Indianapolis','yes','KIND','IND','IND','',3),
  (3496,'KDSM','medium_airport','Des Moines International Airport',41.534,-93.663101,958,'NA','US','US-IA','Des Moines','yes','KDSM','DSM','DSM','',3),
  (3605,'KICT','medium_airport','Wichita Eisenhower National Airport',37.649899,-97.433098,1333,'NA','US','US-KS','Wichita','yes','KICT','ICT','ICT','',3),
  ...
  (3435,'KBWI','large_airport','Baltimore/Washington International Thurgood Marshall Airport',39.1754,-76.668297,146,'NA','US','US-MD','Baltimore','yes','KBWI','BWI','BWI','WAS', 2),
  (3497,'KDTW','large_airport','Detroit Metropolitan Wayne County Airport',42.212398529052734,-83.35340118408203,645,'NA','US','US-MI','Detroit','yes','KDTW','DTW','DTW','DTT, Detroit Metro Airport',3),
  (3709,'KMSP','large_airport','Minneapolis–Saint Paul International Airport',44.882,-93.221802,841,'NA','US','US-MN','Minneapolis','yes','KMSP','MSP','MSP','',3),
  ...
  (3905,'KSTL','large_airport','St Louis Lambert International Airport',38.748697,-90.370003,618,'NA','US','US-MO','St Louis','yes','KSTL','STL','STL','Lambert St Louis',3),
  (3437,'KBZN','medium_airport','Gallatin Field',45.77750015,-111.1529999,4473,'NA','US','US-MT','Bozeman','yes','KBZN','BZN','BZN','',4),
  (4731,'MMMX','large_airport','Licenciado Benito Juarez International Airport',19.4363,-99.072098,7316,'NA','MX','MX-DIF','Mexico City','yes','MMMX','MEX','ME1','AICM',6),
  (4762,'MMUN','large_airport','Cancún International Airport',21.036500930800003,-86.8770980835,22,'NA','MX','MX-ROO','Cancún','yes','MMUN','CUN','','',6),
  (4710,'MMGL','large_airport','Don Miguel Hidalgo Y Costilla International Airport',20.521799087524414,-103.31099700927734,5016,'NA','MX','MX-JAL','Guadalajara','yes','MMGL','GDL','','',6),
  (1986,'CYYT','large_airport','St. John`s International Airport',47.618598938,-52.7518997192,461,'NA','CA','CA-NL',"St. John\'s",'yes','CYYT','YYT','','',5),
